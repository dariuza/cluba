	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">@if(Session::has('titulo')) {{Session::get('titulo')}} @else Nueva @endif Especialidad</div>
				...
				{!! Form::open(array('url' => 'especialidad/save')) !!}			
					<div class="panel-body">
					...
					<div class="form-group">
						...
						<a href="{{ url('especialidad/listar') }}" class="btn btn-primary">Cancelar</a>															
					</div>	
					</div>										
