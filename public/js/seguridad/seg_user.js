...
seg_user.prototype.iniciarPie= function(contenedor_id,titulo,datos,colores){	
	...
	for (i = 0; i < datos.length; i++) { 
	    if(datos[i].name == "Pago pendiente"){datos[i].name = "Prospecto"}
	    if(datos[i].name == "Suscripcion vencida"){datos[i].name = "Suscripción vencida"}
	}
	*/
            ...
            point:{
                events:{
                    click: function (event) {
                    	...
                    	if(this.name == "Prospecto") this.name = "Pago pendiente";
                    	if(this.name == "Suscripción vencida") this.name = "Suscripcion vencida";
                    	window.location="suscripcion/buscar/"+this.name;
                    }
                }
            }  
        }]
