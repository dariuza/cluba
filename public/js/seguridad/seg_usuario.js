...
seg_usuario.prototype.optVerRespuesta = function(result) {	
	...
	$("#user_modal .modal-body .row_izq").html($("#user_modal .modal-body .row_izq").html()+'<div class="col-md-6" >Estado Civil: </div><div class="col-md-6" >'+seg_usuario.table.rows('.selected').data()[0].civil_status+'</div>');
